...
public class pay {
	...
	private void initialize() {
		TicketingDAO td = new TicketingDAO();
		...
		runTime.setText(list.get(0).getRunningTime()); //러닝타임
		
		JComboBox comboBox = new JComboBox();
		comboBox.setBounds(432, 482, 205, 23);
		frame.getContentPane().add(comboBox);
		
		JButton btnNewButton = new JButton("결제하기");
		btnNewButton.setBounds(682, 482, 97, 23);
		frame.getContentPane().add(btnNewButton);
		
		JLabel lblNewLabel_1_4_1 = new JLabel("결제 방법");
		lblNewLabel_1_4_1.setBounds(340, 478, 80, 30);
